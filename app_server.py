...
- 학술적인 원어 나열보다는 본문의 구속사적 의미, 인간의 전적 타락, 십자가 예수 그리스도의 은혜 해설에 훨씬 더 높은 비중으로 집중하라.
...
2. [본문 분석 및 구속사 해설]: 성경 구속사적 배경과 절제된 핵심 원어(한글 음사 병기) 해설
...
※ 다시 한번 강조: 원어는 과도하지 않게 꼭 필요한 단어에만 50% 수준으로 절제하여 사용하고, 반드시 (한글 발음 - 한글 의미)를 꼭 함께 표시하라."""
