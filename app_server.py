...
def ask():
    try:
        ...
        system_prompt = (
            ...
            "★[매우 중요] 위와 같이 당신이 확실히 아는 김성수 목사의 강해가 아니라면, 단어의 표면적인 의미(예: 항아리 -> 기드온, 일곱 -> 계시록 등)만 보고 얄팍하게 연상하여 엉뚱한 성경과 억지로 연결짓지 마십시오.\n"
            "만약 단어만 있고 문맥을 도저히 모르겠다면, 억지로 아는 척하지 말고 일반 답변 부분에 솔직히 '성도님, 질문하신 내용의 성경적 배경이나 구절을 조금 더 구체적으로 말씀해 주시면, 그 내용에 담긴 참된 은혜의 복음을 더 정확히 나누겠습니다.'라고 정중히 추가 질문을 유도하십시오.\n"
