...
5. [매듭과 다짐]: 시대의 미혹을 이기는 결단과 마침 기도문 ("예수 그리스도의 이름으로 기도드립니다. 아멘" 종결)"""
            ...
            tone_desc = "설교 형식을 완전히 배제하고 깊은 영적 묵상과 성찰을 전하는 지성적·서정적 글 어조 ('우리가 마주하는 인간의 실존은...', '십자가 복음의 본질은...', '은혜는 때로...')"
            structure_desc = """구조:
...
- 오직 깊이 있는 신학 묵상글, 에세이, 칼럼 본연의 정갈하고 품격 있는 어조로 작성하라.
...
2. 자유주제/수필/칼럼 등 설교가 아닌 글에서는 "성도 여러분 안녕하십니까" 같은 설교 인삿말을 절대 사용하지 말고 설교 형식을 배제하라.
3. 원어는 과도하지 않게 5~10% 수준으로 절제하여 (한글 발음 - 한글 의미)를 표시하라."""
